<div class="pcoded-inner-content">
	<div class="main-body">
		<div class="page-wrapper">
			<h1>Geolocalización Asambleístas Provinciales</h1>
			<!-- Page body start -->
			<div class="page-body">
				<div class="row">
					<div class="col-md-4">
					...
					<div class="col-md-12">
						...
						<div class="card">
							<div class="card-header">
								<h5>Asambleístas Provinciales</h5>
								<span>Se presenta las ubicaciones de todos los aspirantes a la Asamblea Provincial del
									Ecuador</span>
							</div>
							<div class="card-block">
								<div id="mapaAsamProvinciales" class="set-map" style="height:500px; width:100%;">
								</div>
							</div>
						</div>
						<!-- Basic map end -->
...
<script type="text/javascript">
	function initMap() {
		...
		//SATELLITE
		//TERRAIN
		var mapaUbicacionProvincial = new google.maps.Map(document.getElementById('mapaAsamProvinciales'),
